package com.book.paymentservice.exception;
...
public enum ErrorCode {
    ...
    INVALID_REQUEST(10003, HttpStatus.BAD_REQUEST, "{}"),
    ...
    INVALID_ORDER_STATUS(11203, HttpStatus.BAD_REQUEST, "Invalid order status transition from '%s' to '%s'"),
    ...
    ORDER_ITEMS_EMPTY(11206, HttpStatus.BAD_REQUEST, "Order items cannot be empty"),
    ORDER_ITEM_INVALID_PRODUCT_ID(11207, HttpStatus.BAD_REQUEST, "Product ID cannot be empty"),
    ORDER_ITEM_INVALID_QUANTITY(11208, HttpStatus.BAD_REQUEST, "Quantity must be greater than 0"),
    ORDER_ITEM_INVALID_UNIT_PRICE(11209, HttpStatus.BAD_REQUEST, "Unit price must be greater than 0"),
